...
ext_modules = [Extension("trackfactory.io.cwiggle", ["trackfactory/io/cwiggle.pyx"]),
               ...
               Extension("trackfactory.lib.cintervaltree", ["trackfactory/lib/cintervaltree.pyx"], include_dirs=[numpy_inc]),
               Extension("trackfactory.io.cinterval", ["trackfactory/io/cinterval.pyx"], include_dirs=[numpy_inc])]
